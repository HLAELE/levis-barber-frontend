        ...
        <div className="dashboard-container">
            ...
            <div className="main-content">
                ...
                {activeTab === 'salary' && (
                    <div>
                        <h2>My Salary</h2>
                        <div className="stats-grid" style={{ gridTemplateColumns: '1fr' }}><div className="stat-card"><div className="stat-icon">💰</div><div className="stat-value">M {salary.toLocaleString()}</div><div>Current Monthly Salary</div></div></div>
                        <button className="btn-orange" onClick={downloadSalary}>📥 Download Salary Slip (CSV)</button>
                    </div>
                )}
