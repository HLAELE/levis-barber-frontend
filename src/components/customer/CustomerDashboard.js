...
function CustomerDashboard({ user, onLogout }) {
    ...
    const downloadReceipt = async (appointmentId) => {
        try {
            ...
            link.href = url;
            link.setAttribute('download', `receipt_${appointmentId}.csv`);
            ...
            <div className="main-content">
                ...
                {activeTab === 'appointments' && (
                    <div>
                        ...
                        <button className="btn-orange" style={{ marginBottom: '20px', width: 'auto', padding: '8px 16px' }} onClick={fetchData}>🔄 Refresh</button>
